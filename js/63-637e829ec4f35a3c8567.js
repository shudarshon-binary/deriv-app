...
var TradeCategoriesGIF = function TradeCategoriesGIF(_ref) {
    ...
    var themed_classes = (0, _classnames2.default)(className, (_classNames = {}, _defineProperty(_classNames, className + '--dark', is_dark_theme), _defineProperty(_classNames, className + '--light', !is_dark_theme), _classNames));
    if (category) {
        switch (category) {
            case 'rise_fall' || 'rise_fall_equal':
                TradeTypeGIF = is_dark_theme ? _react2.default.createElement(_imgRiseFallDark2.default, { className: themed_classes }) : _react2.default.createElement(_imgRiseFallLight2.default, { className: themed_classes });
                break;
            case 'high_low':
                TradeTypeGIF = is_dark_theme ? _react2.default.createElement(_imgHigherLowerDark2.default, { className: themed_classes }) : _react2.default.createElement(_imgHigherLowerLight2.default, { className: themed_classes });
                break;
            case 'match_diff':
                TradeTypeGIF = is_dark_theme ? _react2.default.createElement(_imgMatchesDiffersDark2.default, { className: themed_classes }) : _react2.default.createElement(_imgMatchesDiffersLight2.default, { className: themed_classes });
                break;
            case 'even_odd':
                TradeTypeGIF = is_dark_theme ? _react2.default.createElement(_imgEvenOddDark2.default, { className: themed_classes }) : _react2.default.createElement(_imgEvenOddLight2.default, { className: themed_classes });
                break;
            case 'over_under':
                TradeTypeGIF = is_dark_theme ? _react2.default.createElement(_imgOverUnderDark2.default, { className: themed_classes }) : _react2.default.createElement(_imgOverUnderLight2.default, { className: themed_classes });
                break;
            case 'touch':
                TradeTypeGIF = is_dark_theme ? _react2.default.createElement(_imgTouchNoTouchDark2.default, { className: themed_classes }) : _react2.default.createElement(_imgTouchNoTouchLight2.default, { className: themed_classes });
                break;
            default:
                TradeTypeGIF = null;
                break;
