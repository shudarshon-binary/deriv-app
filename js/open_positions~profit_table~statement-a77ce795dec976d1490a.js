...
var _dataTable = __webpack_require__(835);
...
var _reactWindow = __webpack_require__(852);
...
var _tableRow = __webpack_require__(836);
...
var DataTable = function (_React$PureComponent) {
    ...
    function DataTable(props) {
        ...
        _this.resizeDimensions = (0, _lodash2.default)(function () {
            _this.setState({
                width: window.innerWidth - _this.state.window_width + _this.state.width,
    ...
    _createClass(DataTable, [{
        ...
        value: function rowRenderer(_ref) {
            ...
            var item = data_source[index];
            var action = getRowAction && getRowAction(item);

            // If row content is complex, consider rendering a light-weight placeholder while scrolling.
            var content = _react2.default.createElement(_tableRow2.default, {
                className: className,
                row_obj: item,
                columns: columns,
                key: id,
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                ...
                data_source = _props2.data_source,
                footer = _props2.footer,
                is_empty = _props2.is_empty,
...
var _tableCell = __webpack_require__(837);

var _tableCell2 = _interopRequireDefault(_tableCell);

var _tableRowInfo = __webpack_require__(838);
...
var IndicativeCell = function (_React$PureComponent) {
    _inherits(IndicativeCell, _React$PureComponent);

    function IndicativeCell(props) {
        _classCallCheck(this, IndicativeCell);

        var _this = _possibleConstructorReturn(this, (IndicativeCell.__proto__ || Object.getPrototypeOf(IndicativeCell)).call(this, props));
    ...
    _createClass(IndicativeCell, [{
        ...
        value: function componentWillReceiveProps(props) {
            ...
            this.setState(function () {
                return {
                    movement: props.amount >= _this2.state.amount ? 'profit' : 'loss',
                    amount: props.amount
                };
            });
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'open-positions__indicative' },
                _react2.default.createElement(
                    'div',
                    { className: 'open-positions__indicative--amount' },
                    _react2.default.createElement(_money2.default, { amount: Math.abs(amount), currency: currency }),
                    status !== 'no-resale' && amount !== 0 && _react2.default.createElement(_icon2.default, { icon: 'IconPriceMove', type: movement })
                ),
                status === 'no-resale' && _react2.default.createElement(
                    'div',
                    { className: 'open-positions__indicative-no-resale-msg indicative__no-resale-msg' },
...
var ReportsMeta = function ReportsMeta(_ref) {
    var i18n_heading = _ref.i18n_heading,
        ...
        filter_component = _ref.filter_component;
    return _react2.default.createElement(
        'div',
        ...
        filter_component && _react2.default.createElement(
            'div',
...
var _ProgressSliderStream = __webpack_require__(913);
...
var _profitLoss = __webpack_require__(851);

var _marketSymbolIconRow = __webpack_require__(915);

var _marketSymbolIconRow2 = _interopRequireDefault(_marketSymbolIconRow);

var _profit_loss_cell = __webpack_require__(916);
...
var getProfitTableColumnsTemplate = exports.getProfitTableColumnsTemplate = function getProfitTableColumnsTemplate(currency, items_count) {
    return [{
        key: 'icon',
        title: '',
        col_index: 'action_type',
        renderCellContent: function renderCellContent(_ref5) {
            ...
            if (is_footer) return (0, _localize.localize)('Profit/loss on the last [_1] contracts', items_count);
...
var getOpenPositionsColumnsTemplate = exports.getOpenPositionsColumnsTemplate = function getOpenPositionsColumnsTemplate(currency) {
    return [{
        ...
        title: (0, _localize.localize)('Potential profit/loss'),
        col_index: 'profit',
        renderCellContent: function renderCellContent(_ref12) {
            ...
            var profit = row_obj.contract_info.profit;
            // eslint-disable-next-line consistent-return
            return _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)('open-positions__profit-loss', {
                        'open-positions__profit-loss--negative': profit < 0,
                        'open-positions__profit-loss--positive': profit > 0
                    })
                },
                _react2.default.createElement(_money2.default, { amount: Math.abs(profit), currency: currency }),
                _react2.default.createElement(
                    'div',
                    { className: 'open-positions__profit-loss--movement' },
                    _react2.default.createElement(_icon2.default, { icon: 'IconPriceMove', type: profit > 0 ? 'profit' : 'loss' })
                )
            );
        }
    }, {
        ...
        renderCellContent: function renderCellContent(_ref13) {
            ...
            return _react2.default.createElement(_indicativeCell2.default, { amount: +cell_value, currency: currency, status: row_obj.contract_info && !row_obj.is_valid_to_sell ? 'no-resale' : '' });
        }
    }, {
        title: (0, _localize.localize)('Remaining time'),
        col_index: 'id',
        renderCellContent: function renderCellContent(_ref14) {
            var cell_value = _ref14.cell_value;
...
var _progressSliderStream = __webpack_require__(914);
...
var _positionsProgressSlider = __webpack_require__(261);
...
var _underlyingIcon = __webpack_require__(249);

var _icon = __webpack_require__(8);

var _icon2 = _interopRequireDefault(_icon);

var _marketUnderlying = __webpack_require__(124);
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Popover.Popover,
                    {
                        ...
                        alignment: 'top',
                        message: (0, _marketUnderlying.getMarketName)(info_from_shortcode.underlying),
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Popover.Popover,
                    {
                        ...
                        alignment: 'top',
                        message: (0, _marketUnderlying.getTradeTypeName)(info_from_shortcode.category),
                        disable_target_icon: true
                    },
